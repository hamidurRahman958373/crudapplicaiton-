...
<body style="background-color: #D2D2D2;">
     ...
     <div class="topbar text-center" style="height: 80px; width: 80%; background-color: #0B8076; margin: 0 auto;">
          ...
          <div class="alrecord" style="background-color:#FFFFFF; overflow: hidden;height: 480px;margin: 0 auto;width: 80%;">
              <h2 style="  font-weight: bold; margin-top: 15px;margin-left: 36px;">Update Records</h2>
              <div class="form" style="width: 60%; margin: 0 auto; height: 105px; background-color: #E9E9E9;border-radius: 1%; margin-top: 15px;">
                <form action="<?php $_SERVER ['PHP_SELF'] ?>" method="post"  >
                    <label style="font-size: 22px;font-weight: bold;margin-left:px;margin: 12px;" for="">Id</label>
                    <input style="padding: 5px; width: 320px;margin-left: 240px;" type="text" name="sid"><br>
                    <button name ='showbtn' type ='submit' style="margin-left: 300px;background-color: #60646A;border-radius: 1%; margin-top: 5px;color: #FFFFFF; font-weight: bold;padding:5px 15px ;">SHOW</button><br>
                </form>
                <?php  
              ...
              <div class="form" style="width: 60%; margin: 0 auto; height: 280px; background-color: #E9E9E9;border-radius: 1%; margin-top: 15px;">
                <form action="edit1.php" method="post"  >
                   ...
                   <button style="margin-left: 300px;background-color: #60646A;border-radius: 1%; margin-top: 5px;color: #FFFFFF; font-weight: bold;padding:5px 15px ;" type="submit">UPDATE</button>
                </form>
                <?php }
                    }
                   }
