...
<body style="background-color: #D2D2D2;">
     ...
     <div class="topbar text-center" style="height: 80px; width: 80%; background-color: #0B8076; margin: 0 auto;">
          ...
          <div class="alrecord" style="background-color:#FFFFFF; overflow: hidden;height: 480px;margin: 0 auto;width: 80%;">
              <h2 style="  font-weight: bold; margin-top: 15px;margin-left: 36px;">Delete Records</h2>
              <div class="form" style="width: 60%; margin: 0 auto; height: 150px; background-color: #E9E9E9;border-radius: 1%; margin-top: 15px;">
               
                <form action="<?php  $_SERVER['PHP_SELF']?>" method="post"  >
                    <label style="font-size: 22px;font-weight: bold;margin-left:px;margin: 12px;" for="">ID</label>
                     <input style="padding: 5px; width: 320px;margin-left: 198px;" type="text" name="sid"><br>
                    <button name = 'deletebtn' style="margin-left: 300px;background-color: #60646A;border-radius: 1%; margin-top: 5px;color: #FFFFFF; font-weight: bold;padding:5px 15px ;">DELETE</button>
                </form>
              </div>
          </div>
     </section>
